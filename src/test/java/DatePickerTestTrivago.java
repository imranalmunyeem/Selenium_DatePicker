...
public class DatePickerTestTrivago extends BaseTest {
	...
	@Test
	@SneakyThrows
	public void trivagoDatePickerTest() throws InterruptedException {
		// Go to Trivago.com
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(
				".cal-day.cal-is-weekend.cal-is-selectable.cal-is-range.cal-is-range-start,.cal-day.cal-is-selectable.cal-is-range.cal-is-range-start")))
				.click();

		// Select End Date (Wait Visibility then click the end date)
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(
				".cal-day.cal-is-weekend.cal-is-selectable.cal-is-range.cal-is-range-end,.cal-day.cal-is-selectable.cal-is-range.cal-is-range-end")))
				.click();
